...
public class ShiChessComponentRed extends ChessComponent{
    public ShiChessComponentRed(ChessboardPoint chessboardPoint, Point location, ChessColor color) {
    ...
    public boolean canMoveTo(ChessComponent[][] chessboard, ChessboardPoint destination) {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g.drawString("仕", 15, 25); // FIXME: Use library to find the correct offset.
